...
class BlueBotFormFields extends TextFormField {
  BlueBotFormFields({
    super.key,
    ...
    this.inputType,
        ...
        super(
          ...
          decoration: InputDecoration(
            ...
            fillColor: fillColor,
            hintText: hintText,
            hintStyle: BlueBotTheme.themeData.textTheme.headingMedium
  ...
  borderRadius:BorderRadius.zero
            ...
            errorText: errorText,
    errorStyle:
BlueBotTheme.themeData.textTheme.labelSmall
    .copyWith(color: Colors.red)),
          cursorColor:APPColors.appBlack,
          style: style?? BlueBotTheme.themeData.textTheme.headingMedium
