...
class BlueBotTextButton extends StatelessWidget {
  final String? label;
    ...
    return BehaviorSubjectBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        return TextButton(
          ...
          style: BlueBotTheme.of(context).buttonTheme.textButtonStyle.copyWith(
                textStyle: MaterialStateProperty.resolveWith(
                  (states) => BlueBotTheme.of(context).textTheme.bodySmall,
                ),
