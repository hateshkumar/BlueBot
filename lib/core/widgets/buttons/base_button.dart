...
enum BlueBotBaseButtonIconPosition { LEFT, RIGHT }
...
abstract class BlueBotSuperBaseButton extends StatelessWidget {
  late final BehaviorSubject<ButtonState> state$;
  BlueBotSuperBaseButton({
    Key? key,
    bool? enabled,
...
abstract class BlueBotBaseButton extends BlueBotSuperBaseButton {
  ...
  final BlueBotBaseButtonIconPosition? iconPosition;
  final Color? bgColor;
  ...
  TextStyle getTextTheme(BuildContext context) {
    final textTheme = BlueBotTheme.of(context).textTheme;
  ...
  Widget makeContent(BuildContext context, ButtonState state) {
    ...
    if (label == null && icon == null) {
      ...
      effectiveChildren = <Widget>[
        if (iconPosition == BlueBotBaseButtonIconPosition.RIGHT) ...[
